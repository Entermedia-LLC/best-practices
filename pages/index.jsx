...
export default function Page() {
  return (
    <>
      ...
      <Template>
        <Heading section="1">Entermedia Best Practices</Heading>
        <Heading section="2" id="audience" showLink>
          Audience
        </Heading>
        <p>
        ...
        <Heading section="2" id="goal" showLink>
          Goal
        </Heading>
        <p>
        ...
        <Heading section="2" id="contributing" showLink>
          Contributing
        </Heading>
        <p>
